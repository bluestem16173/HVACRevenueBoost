...
/** DG Authority v3 pillar — served from DB catch-all (`/hvac/why-ac-isnt-cooling`). */
export default function HvacWhyAcIsntCoolingPillar() {
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <nav className="mx-auto flex max-w-4xl flex-wrap items-center gap-2 px-4 pt-6 text-sm text-slate-500 dark:text-slate-400">
        ...
        <span className="text-slate-300 dark:text-slate-600">/</span>
        <span className="font-medium text-slate-800 dark:text-slate-200">{HVAC_PILLAR_WHY_AC_ISNT_COOLING_V3.title}</span>
      </nav>
