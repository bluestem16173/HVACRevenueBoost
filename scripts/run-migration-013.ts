...
async function run() {
  ...
  try {
    ...
    const migrationFile = join(migrationsPath, "013_quality_scoring.sql");
    ...
    console.log(`✅ Applied ${applied}/${statements.length} statements for 013_quality_scoring.sql`);
  } catch (err) {
