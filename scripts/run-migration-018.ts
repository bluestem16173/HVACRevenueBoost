...
async function run() {
  ...
  try {
    const migrationFile = join(process.cwd(), "db", "migrations", "018_page_queue_align_columns.sql");
    ...
    console.log("\n📦 Running 018 Migration (page_queue column align)...");
    ...
    console.log(`✅ Applied ${applied}/${statements.length} statements for 018_page_queue_align_columns.sql`);
  } catch (err) {
