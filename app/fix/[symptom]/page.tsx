...
export default async function RepairPage({ params }: { params: { symptom: string } }) {
  ...
  const aiPage = await getDiagnosticPageFromDB(params.symptom, 'fix');
