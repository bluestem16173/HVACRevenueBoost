...
export async function generateStaticParams() {
  return Object.keys(HUB_SLUG_MAP).map((slug) => ({ symptom: slug }));
}

export default async function DiagnosticHubPage({ params }: { params: { symptom: string } }) {
  const hubSlug = HUB_SLUG_MAP[params.symptom] || params.symptom;
  ...
  const title = HUB_TITLES[params.symptom] || hub.name;
