/**
 * Twilio A2P 10DLC — consent string is frozen; bump version if legal text changes.
 */
export const SMS_CONSENT_TEXT_VERSION = "hvacrb-a2p-10dlc-v1-2026-04-16";

/** Exact checkbox / disclosure copy — do not paraphrase or shorten. */
